...
// $Id: snesgamegeniecode.hh,v 1.3 2005/07/30 02:36:45 technoplaza Exp $

#ifndef _SNESGAMEGENIECODE_HH
#define _SNESGAMEGENIECODE_HH
...
namespace emuWorks {
    ...
    private:
         ...
         */
        SNESGameGenieCode(QString &code) { setCode(code); }
    };
}
